# Kontent sample Vue.js single-page application
...
This is a sample website written in JavaScript utilizing the Kontent Delivery API to manage and retrieve content from [Kontent by Kentico](https://kontent.ai). You can register your account for free at <https://app.konent.ai>.
...
This sample wants to showcase either loading content from Kontent as well as load some part of the site from static JSON resources.

> Basically the content that you can't find in the [`Localization`](https://github.com/Kentico/kontent-sample-app-vue/tree/master/src/Localization) JSON is loaded from Kontent.

* All data loaded from Kontent are using [`Stores`](https://github.com/Kentico/kontent-sample-app-vue/tree/master/src/Stores) as for examples "Latest Articles" section ([component here](https://github.com/Kentico/kontent-sample-app-vue/blob/master/src/components/LatestArticles.vue#L111)) on Home Page 
...
At the first run of the app, you'll be presented with a configuration page. It will allow you to connect the app to your Kontent sample project or create a new one. You'll also be able to start a trial and convert to a free plan when the trial expires.
