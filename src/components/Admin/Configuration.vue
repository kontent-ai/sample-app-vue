...
export default {
  ...
  methods: {
    ...
    redirectToHome(newProjectId) {
      ...
      const dataOriginInfo = 'Data on this site originates from Kentico Kontent as well from static JSON resources. To distinguish data sources see https://github.com/Kentico/kontent-sample-app-vue#Data-origin';
